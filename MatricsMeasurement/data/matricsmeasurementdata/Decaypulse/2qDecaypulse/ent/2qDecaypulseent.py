...
if __name__ == '__main__':
  ...
  for _ in range(num_sample):
    ...
    amp = [float(decimal.Decimal(random.randrange(0, 1000))/1000) for _ in range(4)]
    ...
    firstlayer = Decaylayer_pulse2q(backend,amp, ang,duration)
...
#    p = (qi.purity(rho1) + qi.purity(rho2))/2
  ...
  file_open = open('2qDecaylayerentlist.pickle','wb')
  pickle.dump(ent_list,file_open)
  file_open.close()
  file_open = open('2qDecaylayeranglelist.pickle','wb')
  pickle.dump(ang_list,file_open)
  file_open.close()

  file_open = open('2qDecaylayeramplitudelist.pickle','wb')
  pickle.dump(amp_list,file_open)
  file_open.close()
  file_open = open('2qDecaylayerdurationlist.pickle','wb')
