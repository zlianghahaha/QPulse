...
if __name__ == '__main__':
  ...
  for _ in range(num_sample):
    ...
    amp = [float(decimal.Decimal(random.randrange(0, 1000))/1000) for _ in range(6)]
    ...
    firstlayer = block_pulse2qfixedamp(backend,amp, ang,duration)
...
#    p = (qi.purity(rho1) + qi.purity(rho2))/2
  ...
  file_open = open('fixedamp2qentlist.pickle','wb')
  pickle.dump(ent_list,file_open)
  file_open.close()
  file_open = open('fixedamp2qanglelist.pickle','wb')
  pickle.dump(ang_list,file_open)
  file_open.close()

  file_open = open('fixedamp2qamplitudelist.pickle','wb')
  pickle.dump(amp_list,file_open)
  file_open.close()
  file_open = open('fixedamp2qdurationlist.pickle','wb')
