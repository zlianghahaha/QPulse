...
if __name__ == '__main__':
  ...
  for _ in range(num_sample):
    ...
    amp = [float(decimal.Decimal(random.randrange(0, 100))/100) for _ in range(13)]
 ...
 #   ang = [0.8 for _ in range(7)]
    ...
    firstlayer = block_pulse(backend, amp, ang,duration)
...
#    p = (rho1.purity() + rho2.purity())/2
  ...
  file_open = open('4qdressedentlist.pickle','wb')
  pickle.dump(ent_list,file_open)
  file_open.close()
  file_open = open('4qdressedanglelist.pickle','wb')
  pickle.dump(ang_list,file_open)
  file_open.close()

  file_open = open('4qdressedamplitudelist.pickle','wb')
  pickle.dump(amp_list,file_open)
  file_open.close()
  file_open = open('4qdresseddurationlist.pickle','wb')
